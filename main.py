...
def main():
    ...
    parser.add_argument("-j", "--show-junctions", action="store_true", help="Show all junctions in the map and exit")
    parser.add_argument("-t", "--run-tests", action="store_true", help="Run tests and exit")
